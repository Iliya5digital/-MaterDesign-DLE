...
<div class="ot-title-block"><h2>Добавить новость</h2></div>
...
<div class="form-group">
<a href="#" class="ot-short-button btn-block" onclick="$('.addvote').toggle();return false;"><span class="plus_icon circle"><span>+</span></span> Добавить Опрос</a>
</div>
